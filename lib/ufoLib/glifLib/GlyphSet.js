    ...
    )
{
    ...
    enhance(GlyphSet, {
        ...
        rebuildContents: obtain.factory(
            {
              ...
              , filePaths: ['contentsPlist', function(contents) {
                    ...
                    for(name in contents) {
                        ...
                        paths[name] = [this.dirName, fileName].join('/');
                    }
                    return paths;
                }]
            ...
            pointPen/* undefined */)
        {
            ...
            readGlyph.fromString(glyphName, glyphObject, pointPen, formatVersions)
        },
        /**
