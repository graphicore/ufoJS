...
define(
    ...
    enhance(GLIFPointPen, {
        ...
        addPoint: function(
            ...
            name /* default null */,
            // FIXME: in lib/tools/pens/AbstractPointPen is no identifier
            // argument, because that is not original point protocol. In
            // python we can use the **kwargs syntax to reach good extensibility
            // and just add keywords as arguments while staying backwards
            // compatible. But this is not the same for JavaScript, because
            // a generic kwargs object from a generic draw method would
            // in this case end up as identifier! So we MUST document that
            // an identifier can be a key in kwarg.
