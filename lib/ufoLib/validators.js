 ...
 * 
 * todo:
 *    pngValidator and layerContentsValidator throw NotImplementedError
 *    how to handle I/O here?
 */
    ...
    )
{
    ...
    function layerContentsValidator(value, ufoPath) {
        ...
        for(i=0; i<value.length; i++){
            ...
            if(typeof ufoPath !== 'object' || ufoPath.testing !== true) {
                
                throw new NotImplementedError('There\'s nothing like pythons'
                    +' os.path.exists here, yet');
                
                // ===> implement something for os.path.exists then remove
                // the condition around this and the Exception above
