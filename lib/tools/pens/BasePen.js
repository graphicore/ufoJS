    ...
    )
{
    ...
    enhance(BasePen, {
        ...
        {
            throw new NotImplementedError('needs a glypset that exist');
            glyph = this.glyphSet[glyphName];
            if(glyph !== undefined) {
                tPen = new TransformPen(this, transformation);
                glyph.draw(tPen);
            }
        },
        ...
        {
            var points = Array.slice(arguments),//transform arguments to an array
        ...
        qCurveTo: function(/* *points */)
        {
            ...
            if (n > 0) {
                ...
                var _qCurveToOne = self._qCurveToOne,
                ...
                for (i in segments) {
                    ...
                    this.__currentPoint = segments[1]; //pt2
                }
            } else {
                this.lineTo(points[0]);
            }
