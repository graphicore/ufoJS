    ...
    )
{
     ...
     */
    var TransformPen = function(outPen, transformation) {
    ...
    enhance(TransformPen, {
        ...
        curveTo: function(/* *points */)
        {
            ...
            this._outPen.curveTo.apply(_outPen, this._transformPoints(points));
        },
        qCurveTo: function (/* *points */)
        {
            ...
            this._outPen.qCurveTo.apply(_outPen, points);
        },
