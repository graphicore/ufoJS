    ...
    )
{
    ...
    /*********************
     * BasePointPen as seen at the Robofab Project
     *
     ...
     */
    function BasePointPen()
    {
        this.currentPath = null;
    };

    /*inheritance*/
    BasePointPen.prototype = new AbstractPointPen;

    /*definition*/
    enhance(BasePointPen, {
        beginPath: function()
        {
            assert(this.currentPath === null, 'currentPath is not null, call endPath');
            this.currentPath = [];
        },
        /**
        ...
        {
            throw new NotImplementedError('BasePointPen has not _flushContour'
            +' endPath');
        },
        endPath: function()
        {
            assert(this.currentPath !== null, 'currentPath is null, call beginPath');
