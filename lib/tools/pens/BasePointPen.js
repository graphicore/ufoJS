    ...
    )
{
    ...
    /*********************
     * BasePointToSegmentPen as seen at the Robofab Project
     *
    ...
    /*inheritance*/
    BasePointToSegmentPen.prototype = new AbstractPointPen;
    ...
    enhance(BasePointToSegmentPen, {
        ...
        {
            throw new NotImplementedError('BasePointToSegmentPen has not _flushContour'
            +' endPath');
        },
        endPath: function()
        {
